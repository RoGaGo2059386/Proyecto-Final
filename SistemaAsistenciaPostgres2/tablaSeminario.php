...
$consulta = "SELECT *  FROM seminario";
...
<head>
    ...
    <title>Seminarios - SB Admin</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Tabla Seminario</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="principal.php">Home</a></li>
                        <li class="breadcrumb-item active">Tabla-Seminario</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i>
                            Datos de los Seminarios
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th><a type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $row['id'] ?>" data-bs-whatever="@mdo">Editar</a></th>

                                            <th><a href='#' onclick="preguntar(<?php echo $row['id'] ?>)" class="btn btn-danger">Eliminar</a></th>
                                        </tr>

                                        <?php include('modal/modalEditarSeminario.php'); ?>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                ...
                                <a type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#modalSeminario" data-bs-whatever="@mdo">Agregar</a>
                                <?php
                                include('modal/modalAgregarSeminario.php');
                            ...
                            <script type="text/javascript">
                                function preguntar(id) {
                                    if (confirm('¿esta seguro que desea borrar este registro? se borraran todos los registros asociados')) {
                                        window.location.href = "EliminarSeminario.php?id=" + id;
                                    }
                                }
                            </script>
                        </div>
