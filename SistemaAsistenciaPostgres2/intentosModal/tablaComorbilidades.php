...
<head>
    ...
    <title>Comorbilidades - SB Admin</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Tabla Comorbilidades</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="principal.php">Home</a></li>
                        <li class="breadcrumb-item active">Tabla-Comorbilidades</li>
                    </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th><a type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#ModalEditarComorbilidad<?php echo $row['comID']?>" data-bs-whatever="@mdo">Editar</a></th>
                                            <th><a href='#' onclick="preguntar(<?php echo $row['comID'] ?>)" class="btn btn-danger">Eliminar</a></th>
                                            
                                        </tr>
                                    <?php
                                        include('modal/ModalEditarComorbilidad.php');
                                    }
                                    ?>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                ...
                                <a type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#ModalAgregarComorbilidad" data-bs-whatever="@mdo">Agregar Comorbilidades</a>
                                <?php
                                include('modal/modalAgregarComorbilidad.php');
                            ...
                            <script type="text/javascript">
                                function preguntar(id) {
                                    if (confirm('¿esta seguro que desea borrar este registro? se borraran todos los registros asociados')) {
                                        window.location.href = "EliminarComorbilidad.php?id=" + id;
                                    }
                                }
                            </script>
                        </div>
