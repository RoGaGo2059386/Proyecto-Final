...
$sql = "SELECT c.id_clase,c.fecha, c.c_nombre,c.seminario, s.nombre  
FROM clase as c
INNER JOIN 
seminario as s
ON c.seminario=s.id";
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Tabla Clases</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="principal.php">Home</a></li>
                        <li class="breadcrumb-item active">Tabla-Clases</li>
                    </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <th><?php echo $row['id_clase'] ?></th>
                                            <th><?php echo $row['fecha'] ?></th>
                                            <th><?php echo $row['c_nombre'] ?></th>
                                            <th><?php echo $row['seminario'] ?></th>
                                            <th><?php echo $row['nombre'] ?></th>

                                            <th><a type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#ModalEditarClase<?php echo $row['id_clase'] ?>" data-bs-whatever="@mdo">Editar</a></th>
                                            <th><a href='#' onclick="preguntar(<?php echo $row['id_clase'] ?>)" class="btn btn-danger">Eliminar</a></th>
                                            <?php include('modal/modalEditarClase.php'); ?>
                                        </tr>
                                    ...
                                    <script type="text/javascript">
                                        function preguntar(id) {
                                            if (confirm('¿esta seguro que desea borrar este registro? se borraran todos los registros asociados')) {
                                                ...
                                                window.location.href = "EliminarClase.php?id=" + id;
                                            }
                                        }
                                    </script>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                ...
                                <a type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#ModalAgregarClase" data-bs-whatever="@mdo">Agregar</a>

                            </div>

                            <?php
                            include('modal/modalAgregarClase.php');
